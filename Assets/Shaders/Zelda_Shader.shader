	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
        ...
        Pass
        {
            ...
            half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float2 temp_cast_16 = (( ( 50.0 / 2.0 ) * _SpecularTilling )).xx;
				...
				float4 lerpResult217 = lerp( ( ( ( clampResult179 + ( 1.5 * ( ( ( _Color * lerp(tex2D( _AlbedoTex, uv_AlbedoTex ),MixDiffuse28_g1,_Terrain) ) * ( _MainLightColor + float4( 0,0,0,0 ) ) ) * ( ( clampResult180 + (0.2 + (smoothstepResult116 - 0.0) * (0.9 - 0.2) / (1.0 - 0.0)) ) + ( smoothstepResult116 * ( smoothstepResult109 * _SpecularIntensity * _SpecularIntensity ) ) ) ) ) ) * ( 1.0 + ( tex2D( _EmissionTex, uv_EmissionTex ) * _EmissionStrength ) ) ) * AmbientColor ) , color215 , ( (0.0 + (sin( ( GamePausedInt * _Time.y * 2.0 ) ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) * _InteractableGlow ));
				float4 lerpResult1 = lerp( lerpResult217 , float4( 0,0,0,0 ) , _Reflectivity);
				float4 temp_cast_18 = (( ( lerpResult1.r + 0.0 ) / 10.0 )).xxxx;
...
/*ASEBEGIN
Version=17000
-1080;-418;1080;1869;870.1385;1645.986;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;110;-2357.375,574.9367;Float;False;Property;_SpecularSoftness;Specular Softness;9;0;Create;True;0;0;False;0;0.01;0.02;0.01;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;176;-2328.252,-652.0792;Float;False;Property;_ShineClamp;Shine Clamp;11;0;Create;True;0;0;False;0;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;65;-2677.528,-575.6454;Float;True;Property;_AlbedoTex;Albedo Tex;0;0;Create;True;0;0;False;0;None;bd318f2ec3968fd4d8bafd07cb5066ff;False;black;Auto;Texture2D;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.IntNode;227;-219.9786,-722.2753;Float;False;Property;_InteractableGlow;Interactable Glow;31;0;Create;True;0;0;False;0;0;0;0;1;INT;0
Node;AmplifyShaderEditor.NormalizeNode;29;-3664.876,-268.4449;Float;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;181;-2316.628,-379.0469;Float;False;Four Splats First Pass Terrain;13;;1;37452fdfb732e1443b7e39720d05b708;0;6;59;FLOAT4;0,0,0,0;False;60;FLOAT4;0,0,0,0;False;61;FLOAT3;0,0,0;False;57;FLOAT;0;False;58;FLOAT;0;False;62;FLOAT;0;False;6;FLOAT4;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;19;FLOAT3;17
...
Node;AmplifyShaderEditor.ColorNode;131;-1708.78,-712.0515;Float;False;Property;_Color;Color;1;0;Create;True;0;0;False;0;1,1,1,0;0.4056603,0.3352868,0.3004182,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;182;-1789.652,-468.187;Float;False;Property;_Terrain;Terrain;12;0;Create;True;0;0;False;0;0;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.IntNode;206;-954.8453,-1241.712;Float;False;Global;GamePausedInt;GamePausedInt;31;0;Create;True;0;0;False;0;1;0;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;203;-3919.192,1215.94;Float;False;Property;_SpecularTilling;Specular Tilling;8;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;191;2325.018,-665.032;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;164;2937.505,-672.9718;Float;False;True;2;Float;ASEMaterialInspector;0;3;Zelda_Shader;e2514bdcf5e5399499a9eb24d175b9db;True;Base;0;0;Base;5;False;False;False;True;2;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;2;LightMode=LightweightForward;SplatCount=4;False;0;Hidden/InternalErrorShader;0;0;Standard;3;Vertex Position,InvertActionOnDeselection;1;Receive Shadows;1;Built-in Fog;0;0;3;True;True;True;True;5;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=75E00A44E56CC120660FA98C290EFCD83C62CE48