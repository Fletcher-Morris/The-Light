    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float4 lerpResult1 = lerp( ( clampResult179 + ( 1.5 * ( ( _Color * lerp(tex2D( _Albedo, uv_Albedo ),MixDiffuse28_g1,_Terrain) ) * ( ( clampResult180 + (0.2 + (smoothstepResult116 - 0.0) * (0.9 - 0.2) / (1.0 - 0.0)) ) + ( smoothstepResult116 * ( smoothstepResult109 * _SpecularIntensity * _SpecularIntensity ) ) ) ) ) ) , float4( 0,0,0,0 ) , _Reflectivity);
				...
				float4 lerpResult191 = lerp( AmbientColor , LightColor , lerpResult1_g2);
...
/*ASEBEGIN
Version=17000
0;0;1080;1859;-1886.599;1594.367;1.406735;True;False
...
Node;AmplifyShaderEditor.FunctionNode;181;-2304.582,-450.6569;Float;False;Four Splats First Pass Terrain;12;;1;37452fdfb732e1443b7e39720d05b708;0;6;59;FLOAT4;0,0,0,0;False;60;FLOAT4;0,0,0,0;False;61;FLOAT3;0,0,0;False;57;FLOAT;0;False;58;FLOAT;0;False;62;FLOAT;0;False;6;FLOAT4;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;19;FLOAT3;17
...
Node;AmplifyShaderEditor.FunctionNode;238;2455.65,-299.7516;Float;False;LampCheck;-1;;2;0cb7a14e6412b7e4da15d79b5462b235;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;174;2435.393,-634.0195;Float;False;Global;AmbientColor;AmbientColor;10;0;Create;True;0;0;False;0;0.5,0.5,0.5,1;1,1,1,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;243;2437.075,-469.4777;Float;False;Global;LightColor;LightColor;10;0;Create;True;0;0;False;0;1,1,1,1;0.9150943,0.7928828,0.2460395,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;191;1;243;0
WireConnection;191;2;238;0
...
ASEEND*/
//CHKSM=F9B2E6A7948B28B013D4C114CD422D19AAE3387D