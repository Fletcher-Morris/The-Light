    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float4 lerpResult217 = lerp( ( ( clampResult179 + ( 1.5 * ( ( ( _Color * lerp(tex2D( _Albedo, uv_Albedo ),MixDiffuse28_g1,_Terrain) ) * ( _MainLightColor + float4( 0,0,0,0 ) ) ) * ( ( clampResult180 + (0.2 + (smoothstepResult116 - 0.0) * (0.9 - 0.2) / (1.0 - 0.0)) ) + ( smoothstepResult116 * ( smoothstepResult109 * _SpecularIntensity * _SpecularIntensity ) ) ) ) ) ) * ( 1.0 + ( tex2D( _Emission, uv_Emission ) * _EmissionStrength ) ) ) , color215 , ( (0.0 + (sin( ( GamePausedInt * _Time.y * 2.0 ) ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) * _InteractableGlow ));
				...
				float4 lerpResult191 = lerp( ( AmbientColor * lerpResult1 ) , lerpResult1 , lerpResult229);
...
/*ASEBEGIN
Version=17000
0;0;1080;1859;-683.0129;2278.973;1.796658;True;False
...
Node;AmplifyShaderEditor.SimpleAddOpNode;148;1531.936,-785.153;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;174;2078.451,-998.4279;Float;False;Global;AmbientColor;AmbientColor;10;0;Create;True;0;0;False;0;0.5,0.5,0.5,1;0.2735849,0.2026077,0.2550903,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;4;2430.219,-814.982;Float;True;2;2;0;FLOAT4;0,0,0,0;False;1;COLOR;1,1,1,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=2DCA3477DC5FC339B07657BFD4563F9501465486