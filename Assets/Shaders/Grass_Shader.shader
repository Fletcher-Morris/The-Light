    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v)
            {
				...
				float4 temp_cast_2 = (_MaxPlayerBend).xxxx;
				float4 clampResult332 = clamp( ( ifLocalVar323 * appendResult320 * lerp(clampResult328,tex2DNode342.g,_UseTexture) * _MaxPlayerBend ) , ( 0.0 - _MaxPlayerBend ) , temp_cast_2 );
...
/*ASEBEGIN
Version=17000
315;73;1211;666;-1165.73;3384.727;3.589344;True;False
...
Node;AmplifyShaderEditor.Vector3Node;308;2118.637,-3031.258;Float;False;Global;PlayerPosition;PlayerPosition;7;0;Create;True;0;0;False;0;0,0,0;62.32111,67.11655,-396.614;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;354;1973.825,-1822.514;Half;False;Global;WindGust;WindGust;9;0;Create;True;0;0;False;0;0;0.0720197;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6030B43AD37E8C61E1BDD28C7A7F599E1A92BD21