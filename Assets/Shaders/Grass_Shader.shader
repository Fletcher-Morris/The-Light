    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float clampResult253 = clamp( ( IN.ase_texcoord1.xyz.y / _GroundFade ) , 0.0 , 1.0 );
				float4 lerpResult252 = lerp( _GroundColor , _RootColor , clampResult253);
				float temp_output_247_0 = ( IN.ase_texcoord1.xyz.y / _TipHeight );
				...
				float4 break149 = clampResult261;
				...
				float4 lerpResult191 = lerp( ( AmbientColor * ( ( break149.r + break149.g + break149.b ) / 10.0 ) ) , clampResult261 , lerpResult1_g2);
				float4 clampResult368 = clamp( ( 1.0 * lerpResult191 ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
...
/*ASEBEGIN
Version=17000
0;0;1080;1859;-330.6235;2917.583;2.654102;True;False
...
Node;AmplifyShaderEditor.Vector3Node;308;2118.637,-3031.258;Float;False;Global;PlayerPosition;PlayerPosition;7;0;Create;True;0;0;False;0;0,0,0;249.1587,48.25008,-450.4415;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;354;1973.825,-1822.514;Half;False;Global;WindGust;WindGust;9;0;Create;True;0;0;False;0;0;0.1502123;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;149;1360,-784;Float;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.SimpleAddOpNode;148;1632,-784;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;174;1919.013,-1137.117;Float;False;Global;AmbientColor;AmbientColor;10;0;Create;True;0;0;False;0;0.5,0.5,0.5,1;1,1,1,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;366;2361.098,-868.5486;Float;True;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;370;2461.867,-297.9836;Float;False;LampCheck;-1;;2;0cb7a14e6412b7e4da15d79b5462b235;0;0;1;FLOAT;0
...
WireConnection;366;0;174;0
WireConnection;366;1;150;0
...
ASEEND*/
//CHKSM=DB9E1E7175AD056067085A771235C00C2EF88D54