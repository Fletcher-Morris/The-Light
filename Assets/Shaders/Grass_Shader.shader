    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float4 temp_cast_1 = (( ( clampResult261.x + 0.0 ) / 10.0 )).xxxx;
				...
				float4 lerpResult191 = lerp( temp_cast_1 , clampResult261 , lerpResult229);
		        ...
		        float3 Color = ( 1.0 * lerpResult191 ).xyz;
...
/*ASEBEGIN
Version=17000
315;73;1211;666;3509.833;2888.917;6.972956;True;False
...
Node;AmplifyShaderEditor.Vector3Node;308;2118.637,-3031.258;Float;False;Global;PlayerPosition;PlayerPosition;7;0;Create;True;0;0;False;0;0,0,0;267.672,31.80125,-384.7966;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;354;1973.825,-1822.514;Half;False;Global;WindGust;WindGust;9;0;Create;True;0;0;False;0;0;0.9999996;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;364;3305.287,-670.6238;Float;True;2;2;0;FLOAT4;0,2,0,0;False;1;FLOAT4;1,1,1,0;False;1;FLOAT4;0
