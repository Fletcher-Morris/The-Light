    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float4 lerpResult1 = lerp( ( ( ( saturate( ( step( ( temp_output_67_0 + 0.2 ) , fresnelNode69 ) * 2.0 ) ) + ( 1.5 * ( ( ( _Color * tex2D( _AlbedoTex, uv_AlbedoTex ) ) * ( _MainLightColor + float4( 0,0,0,0 ) ) ) * ( ( step( temp_output_67_0 , fresnelNode69 ) + (0.2 + (smoothstepResult116 - 0.0) * (0.9 - 0.2) / (1.0 - 0.0)) ) + ( smoothstepResult116 * ( smoothstepResult109 * _SpecularIntensity * _SpecularIntensity ) ) ) ) ) ) * ( 1.0 + ( tex2D( _EmissionTex, uv_EmissionTex ) * _EmissionStrength ) ) ) * AmbientColor ) , float4( 0,0,0,0 ) , _Reflectivity);
...
/*ASEBEGIN
Version=17000
294;73;1227;666;4717.058;1947.855;7.15745;True;False
...
Node;AmplifyShaderEditor.Vector3Node;140;435.1316,-1283.332;Float;False;Global;LampPosition;LampPosition;10;0;Create;True;0;0;False;0;0,0,0;-1.648,1.361,-0.63;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-1307.144,-467.8509;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;139;831.5317,-1026.231;Float;False;Global;LampRange;LampRange;10;0;Create;True;0;0;False;0;20;9.898815;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;164;1857.76,-559.1481;Float;False;True;2;Float;ASEMaterialInspector;0;3;Zelda_Shader_Amplify;e2514bdcf5e5399499a9eb24d175b9db;True;Base;0;0;Base;5;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=LightweightForward;False;0;Hidden/InternalErrorShader;0;0;Standard;3;Vertex Position,InvertActionOnDeselection;1;Receive Shadows;1;Built-in Fog;0;0;3;True;True;True;False;5;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=082CAAC0B304AEA8493C10614CF7A87726600B7C