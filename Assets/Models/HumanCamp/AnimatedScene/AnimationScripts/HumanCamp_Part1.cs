...
public class HumanCamp_Part1 : MonoBehaviour
{
    ...
    public Animator GetSoldierA() { return SoldierA; }
    public Animator GetSoldierB() { return SoldierB; }
    ...
    {//Make the soldier have random IDLE animations
    ...
    IEnumerator ChiefComes()
    {
        ...
        yield return new WaitForSeconds(1.3f); //see to change according to what people says
    ...
    {
        //TO DO: Add soldier listen to the chief animation
        ...
        StartCoroutine(StartPart2Delay());
        ...
        //Chief IDLE
        ChiefAnim.SetBool("Talking", false);

        
    }

    IEnumerator StartPart2Delay()
    {
        yield return new WaitForSeconds(10f); //Start the incoming of the Patroller before the chief end his speech
        // call part 2 animation
        GetComponent<HumanCamp_Part2>().StartAction();
    }
